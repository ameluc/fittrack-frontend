...
export default function Home() : JSX.Element {
    ...
    return (<>
        <section id="hero" className={ sectionStyle } data-aos="fade-up" data-aos-offset="100">
            { isLGView && <Helper className={ styles.spacer } /> }
        ...
        <section id="features" className={ sectionStyle } data-aos="fade-up" data-aos-offset="100">
            ...
            <div className="w-full h-fit mx-auto flex flex-col items-center justify-center" data-aos="zoom-in" data-aos-offset="100">
                ...
                <div className="flex flex-col gap-4 lg:px-8 lg:flex-row lg:gap-8">
                    <CardFeature className={ styles.feature } featureImg="https://placehold.co/200x200?text=Workout" featureImgText="Workout tracking illustration" featureText="Log your exercises, sets, and reps with ease." featureTitle="Workout Tracking" reverse={ true } />
                    <CardFeature className={ styles.feature } featureImg="https://placehold.co/200x200?text=Nutrition" featureImgText="Nutrition tracking illustration" featureText="Track your calories and macros to stay on target." featureTitle="Nutrition Monitoring" reverse={ isMDView ? false : true } />
                    <CardFeature className={ styles.feature } featureImg="https://placehold.co/200x200?text=Progress" featureImgText="Progress chart illustration" featureText="Visualize your journey with charts and statistics." featureTitle="Progress Insights" reverse={ true } />
                </div>
                <Helper className={ styles.divider } />
            </div>
        </section>
        <section id="testimonials" className={ sectionStyle } data-aos="fade-up" data-aos-offset="100">
            ...
            <div className="w-full h-fit mx-auto flex flex-col items-center justify-center" data-aos="zoom-in" data-aos-offset="100">
                ...
                <div className="w-full h-fit flex flex-col items-center justify-center">
                    <CardTestimonial className={ styles.testimonial } testimonialCite="- Alex, 28" testimonialImg="https://placehold.co/100x100?text=User+1" testimonialImgText="User photo" testimonialText="FitTrack completely changed how I manage my workouts. Highly recommend!" />
                    <div className="w-[50%] h-[1px] mx-auto my-8 bg-gray-600" />
                    <CardTestimonial className={ styles.testimonial } testimonialCite="- Maria, 34" testimonialImg="https://placehold.co/100x100?text=User+2" testimonialImgText="User photo" testimonialText="Finally an app that keeps me consistent. Simple and powerful." />
                </div>
                <Helper className={ styles.divider } />
            </div>
        </section>
        <section id="pricing" className={ sectionStyle } data-aos="fade-up" data-aos-offset="100">
            ...
            <div className="w-full h-fit mx-auto flex flex-col items-center justify-center md:items-end" data-aos="zoom-in" data-aos-offset="100">
                ...
                <div className="w-fit h-fit mx-auto flex flex-col items-center justify-center md:flex-row md:gap-12">
                    <CardPricing className={ styles.pricing } pricingImg="https://placehold.co/150x150?text=Free" pricingImgText="Free plan icon" pricingText="Basic tracking features, unlimited workouts." pricingTitle="Free" />
                    <CardPricing className={ styles.pricing } pricingImg="https://placehold.co/150x150?text=Pro" pricingImgText="Pro plan icon" pricingText="Advanced analytics, nutrition tracking, and personalized insights." pricingTitle="Pro" />
                </div>
                <Helper className={ styles.divider } />
            </div>
        </section>
        <section id="download" className={ sectionStyle } data-aos="fade-up" data-aos-offset="100">
            { isLGView && <div className={ styles.spacer } /> }
